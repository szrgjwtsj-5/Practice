...
public class SWImageView extends AppCompatImageView {
    ...
    private void initial(Context context, AttributeSet attrs) {
        ...
        cornerRadius = array.getDimensionPixelSize(R.styleable.SWImageView_cornerRadius, CORNER_RADIUS_DEFAULT);
        type = array.getInt(R.styleable.SWImageView_type, TYPE_NORMAL);
        border_width = array.getDimensionPixelSize(R.styleable.SWImageView_borderWidth, BORDER_WIDTH);
        border_color = array.getColor(R.styleable.SWImageView_borderColor, BORDER_COLOR);
        array.recycle();
    }
    ...
    private void setBitmapShader() {
        ...
        Bitmap bitmap = ((BitmapDrawable) drawable).getBitmap();        // 可能出错
        if (bitmap == null) {
            return;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (type == TYPE_ROUND) {
            ...
            if (border_width > 0) {
                canvas.drawRoundRect(rectF, cornerRadius, cornerRadius, boder_paint);
            }
    ...
    public void setBorder_color(@ColorInt int border_color) {
    ...
    public void setCornerRadius(int cornerRadius) {
        int px = dp2px(cornerRadius);
        if (this.cornerRadius != px) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(STATE_BORDER_RADIUS, cornerRadius);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            this.cornerRadius = bundle.getInt(STATE_BORDER_RADIUS);
