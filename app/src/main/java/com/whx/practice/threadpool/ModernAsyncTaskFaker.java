 ...
 * {@link AsyncTaskLoaderFaker}.
 */
public abstract class ModernAsyncTaskFaker<Params, Progress, Result> {
    ...
    private static Handler getHandler() {
        synchronized (ModernAsyncTaskFaker.class) {
            if (sHandler == null) {
     ...
     */
    public final ModernAsyncTaskFaker<Params, Progress, Result> execute(Params... params) {
     ...
     */
    public final ModernAsyncTaskFaker<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                             Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final ModernAsyncTaskFaker mTask;
        final Data[] mData;

        AsyncTaskResult(ModernAsyncTaskFaker task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
